...
namespace SparksToothChart {
	...
	public class ToothChartData {
		...
		public ToothChartData Copy() {
			...
			tcd.ListToothGraphics=new ToothGraphicCollection();
			foreach(ToothGraphic tg in ListToothGraphics) {
				tcd.ListToothGraphics.Add(tg.Copy());
			}
