namespace xCrudGenerator {
	partial class Form1 {
		...
		private void InitializeComponent() {
			...
			this.textDb.Text = "development181";
			// 
			// label3
			// 
    ...
    "ges were only to OpenDentBusiness.";
			...
			this.checkRunQueries.Location = new System.Drawing.Point(32, 108);
			...
			this.checkAddToConvertScript.Location = new System.Drawing.Point(32, 91);
