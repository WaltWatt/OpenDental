	...
	public class HL7Tests:TestBase {
		...
		public void HL7_TestAll() {
			...
			foreach(HL7TestInterfaceEnum hl7TestInterfaceEnum in Enum.GetValues(typeof(HL7TestInterfaceEnum))) {
				...
				Assert.AreEqual(Test1(hl7TestInterfaceEnum),"Test 1: Passed.\r\n");
				Assert.AreEqual(Test2(hl7TestInterfaceEnum),"Test 2: Passed.\r\n");
				Assert.AreEqual(Test3(hl7TestInterfaceEnum),"Test 3: Passed.\r\n");
				Assert.AreEqual(Test4(hl7TestInterfaceEnum),"Test 4: Passed.\r\n");
				Assert.AreEqual(Test5(hl7TestInterfaceEnum),"Test 5: Passed.\r\n");
				Assert.AreEqual(Test6(hl7TestInterfaceEnum),"Test 6: Passed.\r\n");
				Assert.AreEqual(Test7(hl7TestInterfaceEnum),"Test 7: Passed.\r\n");
				Assert.AreEqual(Test8(hl7TestInterfaceEnum),"Test 8: Passed.\r\n");
				Assert.AreEqual(Test9(hl7TestInterfaceEnum),"Test 9: Passed.\r\n");
				Assert.AreEqual(Test10(hl7TestInterfaceEnum),"Test 10: Passed.\r\n");
				Assert.AreEqual(Test11(hl7TestInterfaceEnum),"Test 11: Passed.\r\n");
				Assert.AreEqual(Test12(hl7TestInterfaceEnum),"Test 12: Passed.\r\n");
				Assert.AreEqual(Test13(hl7TestInterfaceEnum),"Test 13: Passed.\r\n");
				Assert.AreEqual(Test14(hl7TestInterfaceEnum),"Test 14: Passed.\r\n");
				Assert.AreEqual(Test15(hl7TestInterfaceEnum),"Test 15: Passed.\r\n");
			}
		}
		...
		public string Test1(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			string retval=CompareGuarAndPat(pat,correctPat,guar,correctGuar,hl7TestInterfaceEnum,races);
			if(retval.Length>0) {
		...
		public string Test2(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||ADT^A04||P|2.3"+"\r\n"
				+"EVN|A04|20120901100000||\r\n"
		...
		public string Test3(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||ADT^A04||P|2.3"+"\r\n"
				+"EVN|A04|20120901100000||\r\n"
		...
		public string Test4(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||ADT^A04||P|2.3"+"\r\n"
				+"EVN|A04|20120901100000||\r\n"
		...
		public string Test5(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
		...
		public string Test6(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||SIU^S12||P|2.3"+"\r\n"
			...
			if(hl7TestInterfaceEnum.In(HL7TestInterfaceEnum.EcwOldTight,HL7TestInterfaceEnum.EcwOldFull)) {
			...
			retval+=CompareGuarAndPat(pat,correctPat,guar,correctGuar,hl7TestInterfaceEnum,races);
			if(retval.Length>0) {
		...
		public string Test7(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||SIU^S12||P|2.3"+"\r\n"
		...
		public string Test8(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||SIU^S12||P|2.3"+"\r\n"
		...
		public string Test9(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||SIU^S12||P|2.3"+"\r\n"
				+"SCH|100|100|||||Checkup and Fillings||||^^2400^20120902100000^20120902104000||||||||||||||\r\n"
				+"PID|1|30||A300|Smith2^Jane2^N||19760205|Female||White|421 Main St^Apt 17^Dallas^OR^97338||5035554045|5035554234||Married|||222334444|||Standard\r\n"
		...
		public string Test10(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			string msgtext=@"MSH|^~\&|||||20120901100000||SIU^S12||P|2.3"+"\r\n"
				+"SCH|100|100|||||Checkup and Fillings||||^^2400^20120902100000^20120902104000||||||||||||||\r\n"
		...
		public string Test11(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
		...
		public string Test12(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			if(hl7TestInterfaceEnum==HL7TestInterfaceEnum.EcwOldStandalone 
				|| hl7TestInterfaceEnum==HL7TestInterfaceEnum.HL7DefEcwStandalone) 
			{
		...
		public string Test13(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			if(hl7TestInterfaceEnum==HL7TestInterfaceEnum.EcwOldStandalone 
				|| hl7TestInterfaceEnum==HL7TestInterfaceEnum.HL7DefEcwStandalone) {
		...
		public string Test14(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
		...
		public string Test15(HL7TestInterfaceEnum hl7TestInterfaceEnum) {
			...
			if(prov.FeeSched!=FeeScheds.GetFirst(true).FeeSchedNum) {
				return "Test 15: Provider fee schedule is not set to "+FeeScheds.GetFirst(true).Description+".\r\n";
			}
			return "Test 15: Passed.\r\n";
		}

		///<summary>Compares the pat and guar to correctPat and correctGuar to make sure every field matches.</summary>
		public string CompareGuarAndPat(Patient pat,Patient correctPat,Patient guar,Patient correctGuar,HL7TestInterfaceEnum hl7TestInterfaceEnum
		...
		public string CompareMsgs(MessageHL7 msg,MessageHL7 correctMsg) {
			string retval="";
