...
namespace OpenDentBusiness.Crud {
	public class EServiceBillingCrud {
		...
		public static long Insert(EServiceBilling eServiceBilling,bool useExistingPK) {
			...
			OdSqlParameter paramProceduresJson=new OdSqlParameter("paramProceduresJson",OdDbType.Text,eServiceBilling.ProceduresJson);
			if(eServiceBilling.ChargesJson==null) {
				eServiceBilling.ChargesJson="";
			}
			OdSqlParameter paramChargesJson=new OdSqlParameter("paramChargesJson",OdDbType.Text,eServiceBilling.ChargesJson);
			if(eServiceBilling.NexmoInfoJson==null) {
				eServiceBilling.NexmoInfoJson="";
			}
			OdSqlParameter paramNexmoInfoJson=new OdSqlParameter("paramNexmoInfoJson",OdDbType.Text,eServiceBilling.NexmoInfoJson);
			if(eServiceBilling.LogInfo==null) {
				eServiceBilling.LogInfo="";
			}
			OdSqlParameter paramLogInfo=new OdSqlParameter("paramLogInfo",OdDbType.Text,eServiceBilling.LogInfo);
			if(useExistingPK||PrefC.RandomKeys) {
				Db.NonQ(command,paramProceduresJson,paramChargesJson,paramNexmoInfoJson,paramLogInfo);
			}
			else {
				eServiceBilling.EServiceBillingNum=Db.NonQ(command,true,paramProceduresJson,paramChargesJson,paramNexmoInfoJson,paramLogInfo);
			}
			return eServiceBilling.EServiceBillingNum;
		}
