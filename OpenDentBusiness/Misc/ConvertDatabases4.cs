	...
	public partial class ConvertDatabases {
		...
		private static void To16_2_11() {
			if(FromVersion<new Version("16.2.11.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.11"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_14() {
			if(FromVersion<new Version("16.2.14.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.14"));//No translation in convert script.
				string command;
		...
		private static void To16_2_19() {
			if(FromVersion<new Version("16.2.19.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.19"));//No translation in convert script.
				string command;
		...
		private static void To16_2_20() {
			if(FromVersion<new Version("16.2.20.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.20"));//No translation in convert script.
				string command;
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_24() {
			if(FromVersion<new Version("16.2.24.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.24"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_26() {
			if(FromVersion<new Version("16.2.26.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.26"));//No translation in convert script.
				string command;
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_29() {
			if(FromVersion<new Version("16.2.29.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.29"));//No translation in convert script.
				string command;
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_32() {
			if(FromVersion<new Version("16.2.32.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.32"));//No translation in convert script.
				string command;
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_33() {
			if(FromVersion<new Version("16.2.33.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.33"));//No translation in convert script.
				string command;
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_2_44() {
			if(FromVersion<new Version("16.2.44.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.44"));//No translation in convert script.
				string command;
				...
				for(int i = 0;i < tablePayPlans.Rows.Count;i++) {
					ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.44 - Pay Plan "+(i+1)+" / "+tablePayPlans.Rows.Count));
		...
		private static void To16_2_56() {
			if(FromVersion<new Version("16.2.56.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.2.56"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_3_1() {
			if(FromVersion<new Version("16.3.1.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1"));//No translation in convert script.
				string command;
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Adding Def Links"));
				if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Creating Message Table"));
				if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Loading Messages"));
				...
				foreach(DataRow row in table.Rows) {
					count++;
					ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals ("+count+"/"+table.Rows.Count+")"));
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Removing Old Messages"));
				command="TRUNCATE TABLE signalod";//Truncate the signalod table because all the old data is now meaningless.
				Db.NonQ(command);
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Altering Storage Method"));
				...
				Db.NonQ(command);
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Converting Buttons"));
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - signals | Cleaning Up"));
				if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				#region FHIR
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - FHIR"));//No translation in convert script.
				long fhirProgNum;
				if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - Aging | procedurelog Index"));//No translation in convert script.
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.1 - Aging | claimproc Index"));//No translation in convert script.
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_3_4() {
			if(FromVersion<new Version("16.3.4.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.4.0"));//No translation in convert script.
				string command;
				//==============================ICE Fields==============================
		...
		private static void To16_3_14() {
			if(FromVersion<new Version("16.3.14.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.14"));//No translation in convert script.
				string command;
		...
		private static void To16_3_19() {
			if(FromVersion<new Version("16.3.19.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.19"));//No translation in convert script.
				string command;
		...
		private static void To16_3_20() {
			if(FromVersion<new Version("16.3.20.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.20"));//No translation in convert script.
				string command;
		...
		private static void To16_3_22() {
			if(FromVersion<new Version("16.3.22.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.22"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_3_25() {
			if(FromVersion<new Version("16.3.25.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.25"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_3_29() {
			if(FromVersion<new Version("16.3.29.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.29"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_3_34() {
			if(FromVersion<new Version("16.3.34.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.34"));//No translation in convert script.
				string command;				
				command=@"UPDATE apptreminderrule SET 
					TemplateSMSAggShared='Appointment Confirmation:\n[Appts]\nGoto [ConfirmURL] for confirmation options, or call [ClinicPhone].'
					WHERE TypeCur=1";
		...
		private static void To16_3_45() {
			if(FromVersion<new Version("16.3.45.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.3.45"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_4_1() {
			if(FromVersion<new Version("16.4.1.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.1"));//No translation in convert script.
				string command;
				...
				if(DataConnection.DBtype==DatabaseType.MySql) {
					command="INSERT INTO preference(PrefName,ValueString) VALUES('ApptsRequireProc','0')";
					Db.NonQ(command);
				}
				else {//oracle
					command="INSERT INTO preference(PrefNum,PrefName,ValueString) VALUES((SELECT COALESCE(MAX(PrefNum),0)+1 FROM preference),"
		...
		private static void To16_4_7() {
			if(FromVersion<new Version("16.4.7.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.7"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_4_9() {
			if(FromVersion<new Version("16.4.9.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.9"));//No translation in convert script.
				string command;
		...
		private static void To16_4_11() {
			if(FromVersion<new Version("16.4.11.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.11"));//No translation in convert script.
				string command;
		...
		private static void To16_4_13() {
			if(FromVersion<new Version("16.4.13.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.13"));//No translation in convert script.
				string command;
		...
		private static void To16_4_15() {
			if(FromVersion<new Version("16.4.15.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.15"));//No translation in convert script.
				...
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.15 - Adding index claimproc.DateCP"));//No translation in convert script.
				try {
					if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_4_19() {
			if(FromVersion<new Version("16.4.19.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.19"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
				...
				if(FromVersion>=new Version("16.4.15.0")) {
					...
					if(new[] { "D0270","D0272","D0273" }.All(x => dictProcs.ContainsKey(x))) {
						ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.19 - Reconcile bitewing frequency limitations"));//No translation in convert script.
					...
					if(dictProcs.ContainsKey("D0210")) {
						ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.19 - Reconcile Pano/FMX frequency limitations"));//No translation in convert script.
						command="DELETE FROM benefit "+whereClause+"AND TimePeriod=0 AND CoverageLevel=0 "
					...
					if(new[] { "D0120","D0145","D0150","D0180" }.All(x => dictProcs.ContainsKey(x))) {
						ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.19 - Reconcile exam frequency limitations"));//No translation in convert script.
						command="DELETE FROM benefit "+whereClause+"AND TimePeriod=0 AND CoverageLevel=0 "
		...
		private static void To16_4_23() {
			if(FromVersion<new Version("16.4.23.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.23"));//No translation in convert script.
				string command;
		...
		private static void To16_4_28() {
			if(FromVersion<new Version("16.4.28.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.28"));//No translation in convert script.
				string command;
				if(DataConnection.DBtype==DatabaseType.MySql) {
		...
		private static void To16_4_29() {
			if(FromVersion<new Version("16.4.29.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.29"));//No translation in convert script
				string command;
		...
		private static void To16_4_32() {
			if(FromVersion<new Version("16.4.32.0")) {
				ODEvent.Fire(new ODEventArgs("ConvertDatabases","Upgrading database to version: 16.4.32"));//No translation in convert script
				string command;
