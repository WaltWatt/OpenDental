...
namespace OpenDentBusiness
{
	...
	public class X12ClaimMatch {
		...
		///<summary>All non-zero procedure nums found on the ERA.  Excludes procedures which could not be identified from the ERA.
		///This list of procnums might be shorter than the list of procedures on the ERA claim.</summary>
