...
namespace OpenDentBusiness.Eclaims {
	...
	public class x270Controller {
		...
		public static Etrans RequestBenefits(Clearinghouse clearinghouseClin,InsPlan plan,long patNum,Carrier carrier,List<Benefit> benList,long patPlanNum,InsSub insSub) {
