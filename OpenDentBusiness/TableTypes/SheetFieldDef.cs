...
namespace OpenDentBusiness{
	...
	public class SheetFieldDef:TableBase {
		...
		///<summary>A convenient place to store the image of a field so that it does not have to be repeatedly downloaded from the cloud. Be sure to
		///dispose this field to prevent resource leaks.</summary>
		[XmlIgnore]
		[JsonIgnore]
		[CrudColumn(IsNotDbColumn=true)]
