...
namespace OpenDentBusiness{
	...
	public class TsiTransLog:TableBase {
		...
		///<summary>If DemandType for the placement is TsiDemandType.AcceleratorPr, this will be the Accelerator/Profit Recovery client ID.
		///If TsiDemandType.Collection it will be the Collection client ID. Will always match the first field, Client Number, in the RawMsgText.</summary>
	...
	public enum TsiFKeyType {
		///<summary>-1 - None.  For place, suspend, cancel, </summary>
		None=-1,
