					...
					(/*NOT IN*/
						SELECT A.PatNum FROM (
							...
							WHERE procedurelog.ProcStatus = 2
								...
								(CASE WHEN (procedurelog.DiagnosticCode IN ('520.6','250.8','520.9')
									OR procedurelog.DiagnosticCode2 IN ('520.6','250.8','520.9')
									OR procedurelog.DiagnosticCode3 IN ('520.6','250.8','520.9')
									OR procedurelog.DiagnosticCode4 IN ('520.6','250.8','520.9')
									OR procedurelog.DiagnosticCode IN ('520.6','250.8','520.9')
								...
								AND (procedurelog.DiagnosticCode IN ('520.6', '250.8', '520.9', 'K00.6',
								...
								OR procedurelog.DiagnosticCode2 IN ('520.6', '250.8', '520.9', 'K00.6',
								'520.3','521.00','521.09','521.0','521.02','521.03','522.0','522.5',
								'522.7','525.13','520.0','525.19','K00.3','K02','K02.3','K02.9',
								'K02.52','K02.53','K02.63','K04.0','K04.6','K04.7','K08.13','K08.43',
								'K08.131','K08.132','K08.133','K08.134','K08.139','K08.431',
								...
								OR procedurelog.DiagnosticCode3 IN ('520.6', '250.8', '520.9', 'K00.6',
								'520.3','521.00','521.09','521.0','521.02','521.03','522.0','522.5',
								'522.7','525.13','520.0','525.19','K00.3','K02','K02.3','K02.9',
								'K02.52','K02.53','K02.63','K04.0','K04.6','K04.7','K08.13','K08.43',
								'K08.131','K08.132','K08.133','K08.134','K08.139','K08.431',
								...
								OR procedurelog.DiagnosticCode4 IN ('520.6', '250.8', '520.9', 'K00.6',
								'520.3','521.00','521.09','521.0','521.02','521.03','522.0','522.5',
								'522.7','525.13','520.0','525.19','K00.3','K02','K02.3','K02.9',
								'K02.52','K02.53','K02.63','K04.0','K04.6','K04.7','K08.13','K08.43',
								'K08.131','K08.132','K08.133','K08.134','K08.139','K08.431',
