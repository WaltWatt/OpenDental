...
namespace OpenDentBusiness {
	public class RpProdInc {
		...
		public static DataSet GetDailyData(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool hasBreakdown,bool hasClinicInfo,bool hasChangeInWriteoff,bool isUnearnedIncluded,bool isCEMT=false) {
      ...
      if(!hasClinicInfo) {
        _hasClinics=false;
			...
			DataSet dataSet=GetDailyProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,hasChangeInWriteoff,isUnearnedIncluded,isCEMT);
		...
		///<summary>showUnearedCEMT should only be considered from CEMT (or if you have a "Show Uneared" checkbox, which currently only applies to CEMT).</summary>
		public static DataSet GetProviderDataForClinics(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool hasChangeInWriteoff,bool isUnearnedIncluded,bool isCEMT=false) {
			if(listClinics.Count>0) {
				_hasClinics=true;
			}
			DataSet dataSet=GetDailyProdIncDataSet(dateFrom,dateTo,listProvs,listClinics,writeOffPay,hasAllProvs,hasAllClinics,hasChangeInWriteoff,isUnearnedIncluded,isCEMT);
		...
		public static DataSet GetDailyProdIncDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool writeOffPay,bool hasAllProvs,bool hasAllClinics,bool hasChangeInWriteoff,bool isUnearnedIncluded,bool isCEMT=false) {
		...
		public static DataSet GetProviderPayrollDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool hasAllProvs,bool hasAllClinics) {
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
		...
		public static DataTable GetNetProductionDetailDataSet(DateTime dateFrom,DateTime dateTo,List<Provider> listProvs,List<Clinic> listClinics,bool hasAllProvs,bool hasAllClinics,bool useSnapshotForToday) {
			...
			command=@" 
				SELECT TranType, 
				CalendarDate, 
				Clinic.Description AS ClinicName, 
				details.PatNum, 
