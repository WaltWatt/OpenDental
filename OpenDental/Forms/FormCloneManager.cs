...
namespace OpenDental {
	...
	public partial class FormCloneManager:ODForm {
		...
		private void FillGrids() {
			...
			col=new ODGridColumn("First Name",115);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Last Name",115);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Middle",65);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Gender",65);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("Birthdate",75);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("PriProv",135);
			gridMain.Columns.Add(col);
			col=new ODGridColumn("SecProv",135);
			gridMain.Columns.Add(col);
			gridMain.Rows.Clear();
			ODGridRow row;
