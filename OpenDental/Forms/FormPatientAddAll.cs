...
namespace OpenDental {
	public partial class FormPatientAddAll:ODForm {
		...
		private void FormPatientAddAll_Load(object sender,EventArgs e) {
			...
			FillComboBillTypes(comboBillType1);
			FillComboBillTypes(comboBillType2);
			...
			for(int i=0;i<_listRequiredFields.Count;i++) {
				...
				switch(_listRequiredFields[i].FieldName) {
					...
					case RequiredFieldName.BillingType:
						SetRequiredComboBox(labelBillType,comboBillType1,areConditionsMet,-1,"A billing type must be selected for the guarantor.");
						SetRequiredComboBox(labelBillType,textFName2,textLName2,comboBillType2,areConditionsMet,-1,"A billing type must be selected.");
						SetRequiredComboBox(labelBillType,textFName3,textLName3,comboBillType3,areConditionsMet,-1,"A billing type must be selected.");
						SetRequiredComboBox(labelBillType,textFName4,textLName4,comboBillType4,areConditionsMet,-1,"A billing type must be selected.");
						SetRequiredComboBox(labelBillType,textFName5,textLName5,comboBillType5,areConditionsMet,-1,"A billing type must be selected.");
						break;
					case RequiredFieldName.Birthdate:
						SetRequiredTextBox(labelBirthAge,textBirthdate1,areConditionsMet);
						SetRequiredTextBox(labelBirthAge,textFName2,textLName2,textBirthdate2,areConditionsMet);
						SetRequiredTextBox(labelBirthAge,textFName3,textLName3,textBirthdate3,areConditionsMet);
						SetRequiredTextBox(labelBirthAge,textFName4,textLName4,textBirthdate4,areConditionsMet);
						SetRequiredTextBox(labelBirthAge,textFName5,textLName5,textBirthdate5,areConditionsMet);
						break;
					...
					case RequiredFieldName.Clinic:
						SetRequiredComboBox(labelClinic,comboClinic1,areConditionsMet,0,"Selection cannot be 'Unassigned'.");
						SetRequiredComboBox(labelClinic,comboClinic2,areConditionsMet,0,"Selection cannot be 'Unassigned'.");
						SetRequiredComboBox(labelClinic,comboClinic3,areConditionsMet,0,"Selection cannot be 'Unassigned'.");
						SetRequiredComboBox(labelClinic,comboClinic4,areConditionsMet,0,"Selection cannot be 'Unassigned'.");
						SetRequiredComboBox(labelClinic,comboClinic5,areConditionsMet,0,"Selection cannot be 'Unassigned'.");
						break;
					case RequiredFieldName.EmailAddress:
						SetRequiredTextBox(labelEmail,textEmail1,areConditionsMet);
						SetRequiredTextBox(labelEmail,textFName2,textLName2,textEmail2,areConditionsMet);
						SetRequiredTextBox(labelEmail,textFName3,textLName3,textEmail3,areConditionsMet);
						SetRequiredTextBox(labelEmail,textFName4,textLName4,textEmail4,areConditionsMet);
						SetRequiredTextBox(labelEmail,textFName5,textLName5,textEmail5,areConditionsMet);
						break;
					...
					case RequiredFieldName.PrimaryProvider:
						if(PrefC.GetBool(PrefName.PriProvDefaultToSelectProv)) {
							...
							SetRequiredComboBox(labelPriProv,textFName2,textLName2,comboPriProv2,areConditionsMet,0,"Selection cannot be 'Select Provider'");
							SetRequiredComboBox(labelPriProv,textFName3,textLName3,comboPriProv3,areConditionsMet,0,"Selection cannot be 'Select Provider'");
							SetRequiredComboBox(labelPriProv,textFName4,textLName4,comboPriProv4,areConditionsMet,0,"Selection cannot be 'Select Provider'");
							SetRequiredComboBox(labelPriProv,textFName5,textLName5,comboPriProv5,areConditionsMet,0,"Selection cannot be 'Select Provider'");
						}
						break;
					...
					case RequiredFieldName.SecondaryProvider:
						...
						SetRequiredComboBox(labelSecProv,textFName2,textLName2,comboSecProv2,areConditionsMet,0,"Selection cannot be 'none'");
						SetRequiredComboBox(labelSecProv,textFName3,textLName3,comboSecProv3,areConditionsMet,0,"Selection cannot be 'none'");
						SetRequiredComboBox(labelSecProv,textFName4,textLName4,comboSecProv4,areConditionsMet,0,"Selection cannot be 'none'");
						SetRequiredComboBox(labelSecProv,textFName5,textLName5,comboSecProv5,areConditionsMet,0,"Selection cannot be 'none'");
						break;
					case RequiredFieldName.SocialSecurityNumber:
						SetRequiredTextBox(labelSSN,textSSN1,areConditionsMet);
						SetRequiredTextBox(labelSSN,textFName2,textLName2,textSSN2,areConditionsMet);
						SetRequiredTextBox(labelSSN,textFName3,textLName3,textSSN3,areConditionsMet);
						SetRequiredTextBox(labelSSN,textFName4,textLName4,textSSN4,areConditionsMet);
						SetRequiredTextBox(labelSSN,textFName5,textLName5,textSSN5,areConditionsMet);
						break;
			...
			for(int i=0;i<listConditions.Count;i++) {
				...
				switch(listConditions[i].ConditionType) {
					...
					case RequiredFieldName.Clinic:
						...
						List<ComboBoxClinic> listClinicCombos=new List<ComboBoxClinic>();
		...
		private void SetRequiredTextBox(Label labelCur,TextBox textBoxFName,TextBox textBoxLName,TextBox textBoxRequired,bool areConditionsMet) {
		...
		private void SetRequiredComboBox(Label labelCur,TextBox textBoxFName,TextBox textBoxLName,ComboBox comboBoxRequired,bool areConditionsMet,int disallowedIdx,string errorMsg) {
			if(!string.IsNullOrWhiteSpace(textBoxFName.Text) || !string.IsNullOrWhiteSpace(textBoxLName.Text)) {
				SetRequiredComboBox(labelCur,comboBoxRequired,areConditionsMet,disallowedIdx,errorMsg);
			}
			else {
				_errorProv.SetError(comboBoxRequired,"");
			}
		}
		...
		private void comboClinic1_SelectionChangeCommitted(object sender,EventArgs e) {
			if(comboClinic1.SelectedIndex>-1) {
				comboClinic2.SelectedIndex=comboClinic1.SelectedIndex;
				comboClinic3.SelectedIndex=comboClinic1.SelectedIndex;
				comboClinic4.SelectedIndex=comboClinic1.SelectedIndex;
				comboClinic5.SelectedIndex=comboClinic1.SelectedIndex;
			}
		}
		...
		private void FillListPatStatus(ListBox listBox) {
			listBox.Items.Clear();
			Array listPatStatuses=Enum.GetValues(typeof(PatientStatus));
			foreach(PatientStatus patStatus in listPatStatuses) {
				listBox.Items.Add(patStatus);
			}
