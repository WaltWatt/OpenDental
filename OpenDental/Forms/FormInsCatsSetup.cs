...
namespace OpenDental {
	...
	public class FormInsCatsSetup:ODForm {
		...
		private void FillSpans() {
			...
			ODGridColumn col=new ODGridColumn(Lan.g(this,"Category"),90);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(this,"From Code"),70);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(this,"To Code"),70);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(this,"Hidden"),45);
			gridMain.Columns.Add(col);
			col=new ODGridColumn(Lan.g(this,"E-Benefit Category"),100);
			gridMain.Columns.Add(col);
			gridMain.Rows.Clear();
			ODGridRow row;
			CovSpan[] spansForCat;
