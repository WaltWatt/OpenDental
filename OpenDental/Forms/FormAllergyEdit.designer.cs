namespace OpenDental{
	partial class FormAllergyEdit {
		...
		private void InitializeComponent() {
			...
			// 
			this.butNoneSnomedReaction.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butNoneSnomedReaction.Autosize = true;
			...
			// 
			this.butSnomedReactionSelect.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butSnomedReactionSelect.Autosize = true;
