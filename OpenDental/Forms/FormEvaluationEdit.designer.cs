namespace OpenDental{
	partial class FormEvaluationEdit {
		...
		private void InitializeComponent() {
			...
			this.gridGrades = new OpenDental.UI.ODGrid();
			this.textDate = new OpenDental.ValidDate();
			this.butStudentPicker = new OpenDental.UI.Button();
			this.gridCriterion = new OpenDental.UI.ODGrid();
            ...
            | System.Windows.Forms.AnchorStyles.Left)));
			this.gridCriterion.HScrollVisible = false;
			...
			this.MinimumSize = new System.Drawing.Size(726, 370);
		...
		private UI.ODGrid gridCriterion;
