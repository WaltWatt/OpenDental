namespace OpenDental {
	partial class FormDoseSpotAssignUserId {
		...
		private void InitializeComponent() {
			...
			this.comboDoseUsers = new System.Windows.Forms.ComboBox();
			...
			// comboDoseUsers
			// 
			this.comboDoseUsers.FormattingEnabled = true;
			...
			// butUsertPick
			// 
			this.butUsertPick.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butUsertPick.Autosize = true;
			this.butUsertPick.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butUsertPick.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butUsertPick.CornerRadius = 4F;
		...
		private System.Windows.Forms.ComboBox comboDoseUsers;
