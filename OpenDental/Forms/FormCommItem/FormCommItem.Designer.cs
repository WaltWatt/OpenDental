namespace OpenDental {
	partial class FormCommItem {
		...
		private void InitializeComponent() {
			...
			// butClearNote
			// 
			this.butClearNote.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butClearNote.Autosize = true;
			this.butClearNote.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butClearNote.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butClearNote.CornerRadius = 4F;
			...
			this.textNote.Text = "";
			this.textNote.TextChanged += new System.EventHandler(this.ClearSignature_Event);
			// 
			// listSentOrReceived
			// 
			...
			this.listSentOrReceived.SelectedValueChanged += new System.EventHandler(this.ClearSignature_Event);
			// 
			// label4
			// 
			...
			this.listMode.SelectedIndexChanged += new System.EventHandler(this.ClearSignature_Event);
			// 
			// label3
			// 
			...
			this.textDateTime.TextChanged += new System.EventHandler(this.ClearSignature_Event);
			// 
			// listType
			// 
			...
			this.listType.SelectedIndexChanged += new System.EventHandler(this.ClearSignature_Event);
			// 
			// label2
			// 
		...
		private System.Windows.Forms.Timer timerManualSave;
	}
}