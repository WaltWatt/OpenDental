namespace OpenDental {
	partial class FormMapSetup {
		...
		private void InitializeComponent() {
			...
			// butAddRoom
			// 
			this.butAddRoom.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butAddRoom.Autosize = true;
			this.butAddRoom.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAddRoom.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAddRoom.CornerRadius = 4F;
			this.butAddRoom.Image = global::OpenDental.Properties.Resources.Add;
			...
			this.comboSite.ItemHeight = 13;
			this.comboSite.Location = new System.Drawing.Point(1440, 174);
			this.comboSite.MaxDropDownItems = 30;
