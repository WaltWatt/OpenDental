namespace OpenDental{
	partial class FormAutomationConditionEdit {
		...
		private void InitializeComponent() {
			...
			// butBillingType
			// 
			this.butBillingType.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butBillingType.Autosize = true;
			this.butBillingType.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butBillingType.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butBillingType.CornerRadius = 4F;
