...
namespace OpenDental{
	...
	public class FormScreenGroupEdit:ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.gridScreenPats.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridScreenPats.HasAddButton = false;
			this.gridScreenPats.HasDropDowns = false;
			this.gridScreenPats.HasMultilineHeaders = false;
			this.gridScreenPats.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			this.gridScreenPats.HeaderHeight = 15;
		...
		private void StartScreensForPatsWithSheets() {
			...
			while(true) {
				...
				listProcOrigVals.Add(sheetFieldFluoride==null ? null : sheetFieldFluoride.Copy());//Adds null entry if it's not found, which is fine.
				FormSheetFillEdit FormSFE=new FormSheetFillEdit(sheet);
				FormSFE.ShowDialog();
				if(FormSFE.DialogResult!=DialogResult.OK) {
					break;
