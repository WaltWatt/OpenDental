namespace OpenDental{
	partial class FormUpdateInProgress {
		...
		private void InitializeComponent() {
			...
			// butTryAgain
			// 
			this.butTryAgain.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butTryAgain.Autosize = true;
			this.butTryAgain.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butTryAgain.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butTryAgain.CornerRadius = 4F;
			...
			this.MaximumSize = new System.Drawing.Size(582, 234);
			this.MinimizeBox = false;
			this.MinimumSize = new System.Drawing.Size(582, 234);
