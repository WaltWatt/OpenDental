...
namespace OpenDental {
	public partial class FormCloneAdd:ODForm {
		...
		private void FillComboClinic() {
			...
			{
				comboClinic.Items.Add(new ODBoxItem<Clinic>(Lan.g(this,"Unassigned"),new Clinic() { ClinicNum=0 }));
			}
		...
		private bool IsValid() {
			...
			if(PrefC.HasClinicsEnabled) {
				...
				if(comboClinic.SelectedItem!=null && comboClinic.SelectedItem.GetType()!=typeof(ODBoxItem<Clinic>)) {
					MsgBox.Show(this,"Invalid Clinic selected.");
					return false;
				}
