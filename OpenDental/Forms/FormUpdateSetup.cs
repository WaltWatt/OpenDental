...
namespace OpenDental{
    ...
    " folder and puts a zipped copy into the database.\r\n";
			...
			// butChangeTime
			// 
			this.butChangeTime.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butChangeTime.Autosize = true;
			this.butChangeTime.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butChangeTime.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butChangeTime.CornerRadius = 4F;
