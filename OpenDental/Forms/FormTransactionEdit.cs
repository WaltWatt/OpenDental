...
namespace OpenDental{
	...
	/// </summary>
	public class FormTransactionEdit : ODForm {
		...
		private TextBox textDateTimeEdit;
		...
		private void InitializeComponent()
		{
			...
			this.textDateTimeEdit = new System.Windows.Forms.TextBox();
			...
			// labelReconcile
			// 
			this.labelReconcile.Location = new System.Drawing.Point(9, 88);
			...
			// textReconcile
			// 
			this.textReconcile.Location = new System.Drawing.Point(132, 85);
			...
			// textDateTimeEdit
			// 
			this.textDateTimeEdit.Location = new System.Drawing.Point(132, 33);
			this.textDateTimeEdit.Name = "textDateTimeEdit";
			this.textDateTimeEdit.ReadOnly = true;
			this.textDateTimeEdit.Size = new System.Drawing.Size(147, 20);
			this.textDateTimeEdit.TabIndex = 22;
			// 
			// label10
			// 
			...
			this.label10.Text = "Date/Time Edited";
			...
			this.label11.Text = "User Entered";
			...
			this.Controls.Add(this.textDateTimeEdit);
		...
		private void FormTransactionEdit_Load(object sender,EventArgs e) {
			...
			textDateTimeEdit.Text=TransCur.SecDateTEdit.ToString();
