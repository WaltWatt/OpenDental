...
namespace OpenDental{
	...
	/// </summary>
	public class FormSiteEdit:ODForm {
		...
		private UI.Button butNoneProvider;
		...
		private void InitializeComponent()
		{
			...
			this.butNoneProvider = new OpenDental.UI.Button();
			...
			// butPickProvider
			// 
			this.butPickProvider.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butPickProvider.Autosize = false;
			this.butPickProvider.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butPickProvider.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butPickProvider.CornerRadius = 2F;
			this.butPickProvider.Location = new System.Drawing.Point(396, 66);
			this.butPickProvider.Name = "butPickProvider";
			this.butPickProvider.Size = new System.Drawing.Size(23, 21);
			this.butPickProvider.TabIndex = 3;
			...
			this.comboProviders.Location = new System.Drawing.Point(165, 66);
			this.comboProviders.MaxDropDownItems = 30;
			this.comboProviders.Name = "comboProviders";
			this.comboProviders.Size = new System.Drawing.Size(229, 21);
			this.comboProviders.TabIndex = 2;
			this.comboProviders.SelectedIndexChanged += new System.EventHandler(this.comboProvider_SelectedIndexChanged);
			// 
			// butNoneProvider
			// 
			this.butNoneProvider.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butNoneProvider.Autosize = false;
			this.butNoneProvider.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butNoneProvider.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butNoneProvider.CornerRadius = 2F;
			this.butNoneProvider.Location = new System.Drawing.Point(425, 66);
			this.butNoneProvider.Name = "butNoneProvider";
			this.butNoneProvider.Size = new System.Drawing.Size(44, 21);
			this.butNoneProvider.TabIndex = 4;
			this.butNoneProvider.Text = "None";
			this.butNoneProvider.Click += new System.EventHandler(this.butNoneProvider_Click);
			// 
			// butSiteLink
			// 
			this.butSiteLink.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butSiteLink.Autosize = true;
			this.butSiteLink.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butSiteLink.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butSiteLink.CornerRadius = 4F;
			...
			this.Controls.Add(this.butNoneProvider);
		...
		private void butNoneProvider_Click(object sender,EventArgs e) {
			_selectedProvNum=0;
			comboProviders.SelectedIndex=-1;
		}
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			SiteCur.ProvNum=_selectedProvNum;
