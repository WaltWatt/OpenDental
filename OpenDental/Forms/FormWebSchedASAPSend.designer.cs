namespace OpenDental{
	partial class FormWebSchedASAPSend {
		...
		private void InitializeComponent() {
			...
			this.textEmailTemplate = new OpenDental.ODtextBox();
			...
			this.gridSendDetails = new OpenDental.UI.ODGrid();
			...
			this.butSend.Location = new System.Drawing.Point(506, 546);
			...
			this.butCancel.Location = new System.Drawing.Point(587, 546);
			...
			// textEmailTemplate
			// 
			this.textEmailTemplate.AcceptsTab = true;
			this.textEmailTemplate.BackColor = System.Drawing.SystemColors.Window;
			this.textEmailTemplate.DetectLinksEnabled = false;
			this.textEmailTemplate.DetectUrls = false;
			this.textEmailTemplate.Location = new System.Drawing.Point(24, 239);
			this.textEmailTemplate.Name = "textEmailTemplate";
			this.textEmailTemplate.QuickPasteType = OpenDentBusiness.QuickPasteType.Email;
			this.textEmailTemplate.ScrollBars = System.Windows.Forms.RichTextBoxScrollBars.Vertical;
			this.textEmailTemplate.Size = new System.Drawing.Size(438, 69);
			this.textEmailTemplate.TabIndex = 76;
			this.textEmailTemplate.Text = "";
			// 
			// label2
			// 
			...
			this.textEmailSubject.Location = new System.Drawing.Point(24, 342);
    ...
    " Send is clicked.";
			...
			this.gridSendDetails.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridSendDetails.HasAddButton = false;
			this.gridSendDetails.HasDropDowns = false;
			this.gridSendDetails.HasMultilineHeaders = false;
			this.gridSendDetails.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			this.gridSendDetails.HeaderHeight = 15;
			this.gridSendDetails.HScrollVisible = true;
			this.gridSendDetails.Location = new System.Drawing.Point(24, 376);
			this.gridSendDetails.Name = "gridSendDetails";
			this.gridSendDetails.ScrollValue = 0;
			...
			this.Controls.Add(this.textEmailTemplate);
		...
		private ODtextBox textEmailTemplate;
		...
		private UI.ODGrid gridSendDetails;
	}
}