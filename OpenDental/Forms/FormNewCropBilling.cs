...
namespace OpenDental {
	public partial class FormNewCropBilling:ODForm {
		...
		private void RefreshGridColumns() {
			...
			gridBillingList.Columns.Add(new ODGridColumn("New",isNewWidth,HorizontalAlignment.Center));//0
			gridBillingList.Columns.Add(new ODGridColumn("ErxAccountId",erxAccountIdWidth,HorizontalAlignment.Center));//1
			gridBillingList.Columns.Add(new ODGridColumn("PatNum",patNumWidth,HorizontalAlignment.Center));//2
			gridBillingList.Columns.Add(new ODGridColumn("NPI",npiWidth,HorizontalAlignment.Center));//3
			gridBillingList.Columns.Add(new ODGridColumn("FirstLastName",firstLastNameWidth,HorizontalAlignment.Left));//4
			gridBillingList.Columns.Add(new ODGridColumn("DEA",deaWidth,HorizontalAlignment.Center));//5
			gridBillingList.Columns.Add(new ODGridColumn("DateAdded",dateAddedWidth,HorizontalAlignment.Center));//6
			gridBillingList.Columns.Add(new ODGridColumn("cFTE",compFteWidth,HorizontalAlignment.Center));//7
			gridBillingList.Columns.Add(new ODGridColumn("bFTE",basicFteWidth,HorizontalAlignment.Center));//8
			gridBillingList.Columns.Add(new ODGridColumn("Drug",drugWidth,HorizontalAlignment.Center));//9
			gridBillingList.Columns.Add(new ODGridColumn("Form",formWidth,HorizontalAlignment.Center));//10
			gridBillingList.Columns.Add(new ODGridColumn("EPCS",epcsWidth,HorizontalAlignment.Center));//11
			gridBillingList.Columns.Add(new ODGridColumn("IDP",idpWidth,HorizontalAlignment.Center));//12
			gridBillingList.Columns.Add(new ODGridColumn("PracticeTitle",practiceTitleWidth,HorizontalAlignment.Left));//13
		...
		private void FillGrid() {
			try {
				...
				foreach(NewCropCharge charge in _listNewCropCharges) {
					...
					//0 New
					gr.Cells.Add(new ODGridCell((charge.repeatCharge==null)?"X":""));
					//1 ErxAccountId					
					gr.Cells.Add(new ODGridCell(charge.AccountId));
					//2 PatNum
					if(charge.repeatCharge==null) {
						gr.Cells.Add(new ODGridCell(POut.Long(charge.PatNumForRegKey)));
					}
					else {
						gr.Cells.Add(new ODGridCell(POut.Long(charge.repeatCharge.PatNum)));//Allows techs to manually move repeating charge to another account.
					}
					//3 NPI
					gr.Cells.Add(new ODGridCell(charge.NPI));
					//4 FirstLastName
					gr.Cells.Add(new ODGridCell(charge.FirstName+" "+charge.LastName));
					//5 DEA
					gr.Cells.Add(new ODGridCell(charge.Dea));
					//6 DateAdded
					gr.Cells.Add(new ODGridCell(charge.DateAdded));
					//7 CompFTE
					gr.Cells.Add(new ODGridCell(charge.CompFTEPercent));
					//8 BasicFTE
					gr.Cells.Add(new ODGridCell(charge.BasicFTEPercent));
					//9 Drug
					gr.Cells.Add(new ODGridCell((charge.DrugChecks=="Active")?"Y":"N"));
					//10 Drug
					gr.Cells.Add(new ODGridCell((charge.ForumaryChecks=="Active")?"Y":"N"));
					//11 EPCS
					gr.Cells.Add(new ODGridCell(charge.EPCS));
					//12 IDP
					gr.Cells.Add(new ODGridCell(charge.IDP));
					//13 PracticeTitle
					gr.Cells.Add(new ODGridCell(charge.AccountName));
