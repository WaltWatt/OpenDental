namespace OpenDental{
	partial class FormInsVerificationList {
		...
		private void InitializeComponent() {
			...
			this.gridPastDue = new OpenDental.UI.ODGrid();
			...
			this.listBoxVerifyRegions = new System.Windows.Forms.ListBox();
			this.listBoxVerifyClinics = new System.Windows.Forms.ListBox();
			...
			this.gridPastDue.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridPastDue.HasAddButton = false;
			this.gridPastDue.HasDropDowns = false;
			this.gridPastDue.HasMultilineHeaders = false;
			this.gridPastDue.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			this.gridPastDue.HeaderHeight = 15;
			this.gridPastDue.HScrollVisible = false;
			this.gridPastDue.Location = new System.Drawing.Point(1, 1);
			this.gridPastDue.Name = "gridPastDue";
			this.gridPastDue.ScrollValue = 0;
			...
			// butClose2
			// 
			this.butClose2.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butClose2.Autosize = true;
			this.butClose2.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butClose2.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butClose2.CornerRadius = 4F;
			...
			this.gridAssign.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			this.gridAssign.HasAddButton = false;
			this.gridAssign.HasDropDowns = false;
			this.gridAssign.HasMultilineHeaders = false;
			this.gridAssign.HeaderFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F, System.Drawing.FontStyle.Bold);
			...
			// 
			this.listBoxVerifyRegions.FormattingEnabled = true;
			this.listBoxVerifyRegions.Location = new System.Drawing.Point(346, 33);
			this.listBoxVerifyRegions.Name = "listBoxVerifyRegions";
			this.listBoxVerifyRegions.SelectionMode = System.Windows.Forms.SelectionMode.MultiExtended;
			...
			// 
			this.listBoxVerifyClinics.FormattingEnabled = true;
			this.listBoxVerifyClinics.Location = new System.Drawing.Point(564, 9);
			this.listBoxVerifyClinics.Name = "listBoxVerifyClinics";
			this.listBoxVerifyClinics.SelectionMode = System.Windows.Forms.SelectionMode.MultiExtended;
			...
			// 
			this.textAppointmentScheduledDays.Location = new System.Drawing.Point(213, 11);
			...
			// 
			this.textPatientEnrollmentDays.Location = new System.Drawing.Point(213, 55);
			...
			// 
			this.textInsBenefitEligibilityDays.Location = new System.Drawing.Point(213, 33);
		...
		private UI.ODGrid gridPastDue;
		private System.Windows.Forms.ListBox listBoxVerifyClinics;
		private System.Windows.Forms.ListBox listBoxVerifyRegions;
