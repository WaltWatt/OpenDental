namespace OpenDental{
	partial class FormConnectionLost {
		...
		private void InitializeComponent() {
			...
			// butRetry
			// 
			this.butRetry.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butRetry.Autosize = true;
			this.butRetry.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butRetry.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butRetry.CornerRadius = 4F;
