...
namespace OpenDental{
	...
	/// </summary>
	public class FormLetterMergeEdit : ODForm {
    ...
    "s muliple rows to select quickly.";
			...
			this.comboImageCategory.Location = new System.Drawing.Point(272, 124);
			this.comboImageCategory.MaxDropDownItems = 30;
			this.comboImageCategory.Name = "comboImageCategory";
			this.comboImageCategory.Size = new System.Drawing.Size(222, 21);
			this.comboImageCategory.TabIndex = 36;
			// 
			// FormLetterMergeEdit
			// 
