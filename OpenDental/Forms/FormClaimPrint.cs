			...
			for(int i=0;i<ClaimFormCur.Items.Count;i++){
				if(ClaimFormCur.Items[i].ImageFileName==""){//field
					...
					if(ClaimFormCur.Items[i].FieldName=="P1Fee"
						...
						|| ClaimFormCur.Items[i].FieldName=="P11Fee"
						|| ClaimFormCur.Items[i].FieldName=="P12Fee"
						|| ClaimFormCur.Items[i].FieldName=="P13Fee"
						|| ClaimFormCur.Items[i].FieldName=="P14Fee"
						|| ClaimFormCur.Items[i].FieldName=="P15Fee"
		...
		private void FillDisplayStrings(bool isRenaissance){
			...
			//this is where the procedures used to be
					...
					case "IsAccident":
						...
						else if(CultureInfo.CurrentCulture.Name.EndsWith("CA") && ClaimCur.AccidentDate.Year > 1860) {
							displayStrings[i]="X";
						}
						break;
					case "AccidentDate":
					...
					case "BillingDentistLicenseNum":
						displayStrings[i]=providerClaimBill.StateLicense;
						break;
					...
					case "TreatingDentistLicense":
						displayStrings[i]=providerClaimTreat.StateLicense;
						break;
