namespace OpenDental.User_Controls.SetupWizard {
    ...
    "odes.";
			...
			// butProcCodeTools
			// 
			this.butProcCodeTools.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butProcCodeTools.Autosize = true;
			this.butProcCodeTools.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butProcCodeTools.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butProcCodeTools.CornerRadius = 4F;
			...
			// butChangeRegKey
			// 
			this.butChangeRegKey.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butChangeRegKey.Autosize = true;
			this.butChangeRegKey.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butChangeRegKey.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butChangeRegKey.CornerRadius = 4F;
