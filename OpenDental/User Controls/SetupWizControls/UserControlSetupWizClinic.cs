...
namespace OpenDental.User_Controls.SetupWizard {
	public partial class UserControlSetupWizClinic:SetupWizControl {
		...
		private void FillGrid() {
			...
			col = new ODGridColumn("Abbrev",70);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("Phone",100);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("Address",120);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("City",90);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("State",50);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("ZIP",80);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("Default Prov",75);
			gridMain.Columns.Add(col);
			col = new ODGridColumn("IsHidden",55,HorizontalAlignment.Center);
			gridMain.Columns.Add(col);
			gridMain.Rows.Clear();
			ODGridRow row;
