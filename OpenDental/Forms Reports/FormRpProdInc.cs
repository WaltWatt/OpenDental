...
///<summary></summary>
	public class FormRpProdInc : ODForm {
    ...
    private CheckBox checkClinicInfo;
		...
		private void InitializeComponent()
		{
			...
			this.checkAllProv.Location = new System.Drawing.Point(38, 137);
			...
			this.radioWriteoffBoth.Text = "Use initial claim date for writeoff estimates, ins pay date for writeoff adjustme" +
    "nts";
			...
			this.checkUnearned.Location = new System.Drawing.Point(89, 137);
			this.checkUnearned.Name = "checkUnearned";
			this.checkUnearned.Size = new System.Drawing.Size(102, 16);
		...
		private void RunDaily() {
			...
			DataSet dataSetDailyProd=RpProdInc.GetDailyData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked
				,checkAllProv.Checked,checkAllClin.Checked,checkClinicBreakdown.Checked,checkClinicInfo.Checked,radioWriteoffBoth.Checked,checkUnearned.Checked);
      ...
      Font font=new Font("Tahoma",8);
		...
		private void RunMonthly(){
			...
			ReportComplex report=new ReportComplex(true,radioWriteoffBoth.Checked);
			if(checkAllProv.Checked) {
				for(int i=0;i<listProv.Items.Count;i++) {
					listProv.SetSelected(i,true);
				}
			...
			DataSet ds=RpProdInc.GetMonthlyData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,radioWriteoffBoth.Checked,checkUnearned.Checked);
			...
			if(!PrefC.GetBool(PrefName.EasyNoClinics) && listClin.SelectedIndices.Count>1 && checkClinicBreakdown.Checked) {
				...
				query.AddColumn("Tot Income",totincomewidth,FieldValueType.Number,font);
				if(radioWriteoffBoth.Checked) {
					query.AddGroupSummaryField("Total Production (Production + Scheduled + Adjustments - Writeoff Ests - WriteoffAdjs): ","Writeoff Est","Tot Prod",SummaryOperation.Sum,new List<int>() { 2 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),250,20);
					query.AddGroupSummaryField("Total Income (Pt Income + Ins Income): ","Writeoff Est","Total Income",SummaryOperation.Sum,new List<int>() { 2 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,25);
				}
				else {
				...
				if(radioWriteoffBoth.Checked) {
					query.AddGroupSummaryField("Total Production (Production + Scheduled + Adjustments - Writeoff Ests - WriteOffAdjs): ","Writeoff Est","Tot Prod",SummaryOperation.Sum,new List<int>() { 1 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),250,20);
					query.AddGroupSummaryField("Total Income (Pt Income + Ins Income): ","Writeoff Est","Total Income",SummaryOperation.Sum,new List<int>() { 1 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,25);
				}
				else {
		...
		private void RunAnnual(){
			...
			DataSet ds=RpProdInc.GetAnnualData(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,radioWriteoffBoth.Checked,checkUnearned.Checked);
			DataTable dt=ds.Tables["Total"];
			DataTable dtClinic=new DataTable();
			if(!PrefC.GetBool(PrefName.EasyNoClinics)) {
				dtClinic=ds.Tables["Clinic"];
			...
			if(!PrefC.GetBool(PrefName.EasyNoClinics) && listClin.SelectedIndices.Count>1 && checkClinicBreakdown.Checked) {
				...
				query.AddColumn("Total Income",totincomewidth,FieldValueType.Number);
				if(radioWriteoffBoth.Checked) {
					query.AddGroupSummaryField("Total Production (Production + Adjustments - Writeoff Ests - Writeoff Adjs): ","Writeoff Est","Tot Prod",SummaryOperation.Sum,new List<int>() { 2 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),224,20);
					query.AddGroupSummaryField("Total Income (Pt Income + Ins Income): ","Writeoff Est","Total Income",SummaryOperation.Sum,new List<int>() { 2 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,27);
				}
				else {
				...
				if(radioWriteoffBoth.Checked) {
					query.AddGroupSummaryField("Total Production (Production + Adjustments - Writeoff Ests - Writeoff Adjs): ","Writeoff Est","Tot Prod",SummaryOperation.Sum,new List<int>() { 1 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),224,20);
					query.AddGroupSummaryField("Total Income (Pt Income + Ins Income): ","Writeoff Est","Total Income",SummaryOperation.Sum,new List<int>() { 1 },Color.Black,new Font("Tahoma",9,FontStyle.Bold),0,25);
				}
				else {
		...
		private void RunProvider() {
			...
			DataSet ds=RpProdInc.GetProviderDataForClinics(dateFrom,dateTo,listProvs,listClinics,radioWriteoffPay.Checked,checkAllProv.Checked,checkAllClin.Checked,radioWriteoffBoth.Checked,checkUnearned.Checked);
