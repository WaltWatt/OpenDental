namespace OpenDental {
	partial class ODjobTextEditor {
		...
		private void InitializeComponent() {
			...
			this.butApplyFont = new System.Windows.Forms.Button();
			...
			this.textRequirements = new OpenDental.ODtextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.panel7 = new System.Windows.Forms.Panel();
			this.splitContainer1 = new System.Windows.Forms.SplitContainer();
			this.panel8 = new System.Windows.Forms.Panel();
			this.textImplementation = new OpenDental.ODtextBox();
			...
			this.panel3.Controls.Add(this.butApplyFont);
			...
			// butApplyFont
			// 
			this.butApplyFont.AutoSize = true;
			this.butApplyFont.Enabled = false;
			this.butApplyFont.FlatStyle = System.Windows.Forms.FlatStyle.Popup;
			this.butApplyFont.Location = new System.Drawing.Point(178, 0);
			this.butApplyFont.Name = "butApplyFont";
			this.butApplyFont.Size = new System.Drawing.Size(43, 24);
			this.butApplyFont.TabIndex = 196;
			this.butApplyFont.Text = "Apply";
			this.butApplyFont.Click += new System.EventHandler(this.butApplyFont_Click);
			// 
			// panel4
			// 
			...
			// textRequirements
			// 
			this.textRequirements.AcceptsTab = true;
			this.textRequirements.BackColor = System.Drawing.SystemColors.Window;
			this.textRequirements.DetectLinksEnabled = false;
			this.textRequirements.DetectUrls = false;
			this.textRequirements.Dock = System.Windows.Forms.DockStyle.Fill;
			this.textRequirements.EditMode = true;
			this.textRequirements.HideSelection = false;
			this.textRequirements.Location = new System.Drawing.Point(0, 13);
			...
			this.label1.Size = new System.Drawing.Size(855, 13);
			this.label1.TabIndex = 197;
			this.label1.Text = "Concept (job must meet concept requirements)";
			// 
			// panel7
			// 
			this.panel7.Controls.Add(this.textRequirements);
			this.panel7.Controls.Add(this.label1);
			this.panel7.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panel7.Location = new System.Drawing.Point(0, 0);
			this.panel7.Name = "panel7";
			this.panel7.Size = new System.Drawing.Size(855, 148);
			...
			this.splitContainer1.Size = new System.Drawing.Size(855, 496);
			this.splitContainer1.SplitterDistance = 148;
			this.splitContainer1.TabIndex = 197;
			// 
			// panel8
			// 
			this.panel8.Controls.Add(this.textImplementation);
			this.panel8.Controls.Add(this.label2);
			this.panel8.Dock = System.Windows.Forms.DockStyle.Fill;
			this.panel8.Location = new System.Drawing.Point(0, 0);
			this.panel8.Name = "panel8";
			this.panel8.Size = new System.Drawing.Size(855, 344);
			this.panel8.TabIndex = 199;
			// 
			// textImplementation
			// 
			this.textImplementation.AcceptsTab = true;
			this.textImplementation.BackColor = System.Drawing.SystemColors.Window;
			this.textImplementation.DetectLinksEnabled = false;
			this.textImplementation.DetectUrls = false;
			this.textImplementation.Dock = System.Windows.Forms.DockStyle.Fill;
			this.textImplementation.EditMode = true;
			this.textImplementation.HideSelection = false;
			this.textImplementation.Location = new System.Drawing.Point(0, 13);
			this.textImplementation.Name = "textImplementation";
			this.textImplementation.QuickPasteType = OpenDentBusiness.QuickPasteType.JobManager;
			this.textImplementation.ScrollBars = System.Windows.Forms.RichTextBoxScrollBars.Vertical;
			this.textImplementation.Size = new System.Drawing.Size(855, 331);
			this.textImplementation.SpellCheckIsEnabled = false;
			this.textImplementation.TabIndex = 169;
			...
			this.label2.Size = new System.Drawing.Size(855, 13);
			this.label2.TabIndex = 197;
			this.label2.Text = "Writeup";
			// 
			// ODjobTextEditor
			// 
		...
		private ODtextBox textRequirements;
		private System.Windows.Forms.Button butApplyFont;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Panel panel7;
		private System.Windows.Forms.SplitContainer splitContainer1;
		private System.Windows.Forms.Panel panel8;
		private ODtextBox textImplementation;
