namespace OpenDental {
	partial class FormBugEdit {
		...
		private void InitializeComponent() {
			...
			// butLast3found
			// 
			this.butLast3found.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast3found.Autosize = true;
			this.butLast3found.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast3found.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast3found.CornerRadius = 4F;
			...
			// butLast2found
			// 
			this.butLast2found.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast2found.Autosize = true;
			this.butLast2found.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast2found.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast2found.CornerRadius = 4F;
			...
			// butLast1found
			// 
			this.butLast1found.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast1found.Autosize = true;
			this.butLast1found.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast1found.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast1found.CornerRadius = 4F;
			...
			// butLast3
			// 
			this.butLast3.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast3.Autosize = true;
			this.butLast3.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast3.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast3.CornerRadius = 4F;
			...
			// butLast2
			// 
			this.butLast2.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast2.Autosize = true;
			this.butLast2.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast2.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast2.CornerRadius = 4F;
			...
			// butLast1
			// 
			this.butLast1.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butLast1.Autosize = true;
			this.butLast1.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butLast1.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butLast1.CornerRadius = 4F;
			...
			// butCopyDown
			// 
			this.butCopyDown.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butCopyDown.Autosize = true;
			this.butCopyDown.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butCopyDown.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butCopyDown.CornerRadius = 4F;
