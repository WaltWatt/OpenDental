namespace OpenDental{
	partial class FormJobTime {
		...
		private void InitializeComponent() {
			...
			this.gridJobs = new OpenDental.UI.ODGrid();
			this.SuspendLayout();
			// 
			// butOK
			// 
			...
			this.gridJobs.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
