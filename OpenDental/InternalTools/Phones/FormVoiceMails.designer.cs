namespace OpenDental{
	partial class FormVoiceMails {
		...
		private void InitializeComponent() {
			...
			this.gridVoiceMails = new OpenDental.UI.ODGrid();
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gridVoiceMails.CellFont = new System.Drawing.Font("Microsoft Sans Serif", 8.5F);
			...
			this.gridVoiceMails.ScrollValue = 0;
			...
			// butCreateTask
			// 
			this.butCreateTask.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butCreateTask.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.butCreateTask.Autosize = true;
			this.butCreateTask.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butCreateTask.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butCreateTask.CornerRadius = 4F;
		...
		private UI.ODGrid gridVoiceMails;
