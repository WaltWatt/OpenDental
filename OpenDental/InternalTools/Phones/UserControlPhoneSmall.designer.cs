namespace OpenDental {
	partial class UserControlPhoneSmall {
		...
		private void InitializeComponent() {
			...
			this.comboRoom.Location = new System.Drawing.Point(0, 226);
			this.comboRoom.Name = "comboRoom";
			this.comboRoom.Size = new System.Drawing.Size(213, 21);
			this.comboRoom.TabIndex = 2;
			this.comboRoom.Visible = false;
			...
			// butGetConfRoom
			// 
			this.butGetConfRoom.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butGetConfRoom.Autosize = true;
			this.butGetConfRoom.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butGetConfRoom.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butGetConfRoom.CornerRadius = 4F;
			...
			// butConfRooms
			// 
			this.butConfRooms.AdjustImageLocation = new System.Drawing.Point(0, 0);
			...
			this.butConfRooms.Autosize = true;
			this.butConfRooms.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butConfRooms.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butConfRooms.CornerRadius = 4F;
