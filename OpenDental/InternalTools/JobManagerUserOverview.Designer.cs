namespace OpenDental {
	partial class JobManagerUserOverview {
		...
		private void InitializeComponent() {
			...
			// butAssignOnDeck
			// 
			this.butAssignOnDeck.AdjustImageLocation = new System.Drawing.Point(0, 0);
			this.butAssignOnDeck.Autosize = true;
			this.butAssignOnDeck.BackColor = System.Drawing.SystemColors.ControlLight;
			this.butAssignOnDeck.BtnShape = OpenDental.UI.enumType.BtnShape.Rectangle;
			this.butAssignOnDeck.BtnStyle = OpenDental.UI.enumType.XPStyle.Silver;
			this.butAssignOnDeck.CornerRadius = 4F;
